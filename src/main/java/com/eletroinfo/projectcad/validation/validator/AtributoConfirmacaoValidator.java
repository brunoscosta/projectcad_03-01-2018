package com.eletroinfo.projectcad.validation.validator;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object> {
	...
	public boolean isValid(Object object, ConstraintValidatorContext context) {
		...
		try {
			...
			valido = saoNull(valorAtributo, valorAtributoConfirmacao) || saoIguais(valorAtributo, valorAtributoConfirmacao);
		} catch (Exception e) {
	...
	private boolean saoNull(Object valorAtributo, Object valorAtributoConfirmacao) {
